...
1. Télécharger les fichiers du plugin et les placer dans le dossier: `/wp-content/plugins/highlight-js`.
2. Puis, le plugin devrait apparaître dans le tableau de bord de Wordpress, il faudra alors l'activer.
3. Se placer à la racine du dossier du plugin et lancer la commande `npm run build` dans le terminal.
4. Enfin, lancer `npm start`.
